...
class CryptoApp:
    ...
    def _build_form_widgets(self, parent):
        ...
        ttk.Button(copy_f, text='Вставить из буфера',
                   command=self._paste_from_clipboard).pack(side=tk.LEFT, padx=(0, 6))
    ...
    def _paste_from_clipboard(self):
        try:
            ...
            self.status_var.set("Буфер обмена пуст или недоступен")
            return
        if text:
            self.input_text.delete('1.0', tk.END)
